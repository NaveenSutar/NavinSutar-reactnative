...
import { SafeAreaView, StyleSheet, FlatList, View, TouchableOpacity, ActivityIndicator } from 'react-native'
import { MTDK_Colours, MTDK_Dimensions, API } from '../constants'
import { Body_2, Heading_2 } from '../components/Fonts';
...
const styles = StyleSheet.create({
    ...
    flatlist: {
        ...
        paddingStart: MTDK_Dimensions.padding
    },
